...
const contractIndexerAddress = '0x07B14d36e0334DbaFa9eABd5e4dA8823F968D813';
...
const contractJnsAddress = '0x5cB15703A6c7FF4eB6499b0bf19E9181c7dCa343';
...
describe('ListByTags tests', function() {
  it('Return empty websites', async () => {
    ...
    const result = await indexerService.ListByTags(['test'], 1, 10);
