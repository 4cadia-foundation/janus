...
export interface Dag {
    get(cid: IpfsPath, pathOrOptions?: string | Partial<GetOptions>): Promise<GetResult>;
    get(cid: IpfsPath, callback: Promise<GetResult>): void;
    get(cid: IpfsPath, pathOrOptions: string | Partial<GetOptions>, callback: Promise<GetResult>): void;
    ...
    put(dagNode: any, options: Partial<PutOptions>, callback: NodeCallback<CID>): void;

    tree(cid: IpfsPath, pathOrOptions?: string | Partial<TreeOptions>): Promise<string[]>;
    ...
    tree(cid: IpfsPath, pathOrOptions: string | Partial<TreeOptions>, callback: NodeCallback<string[]>): void;
