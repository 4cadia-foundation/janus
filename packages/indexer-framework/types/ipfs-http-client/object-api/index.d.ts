...
export type LinksOptions = DataOptions;
...
export type PutObjectOptions = DataOptions;

export type GetObjectOptions = DataOptions;

export type PathObjectOptions = DataOptions;
...
export interface _Object {
    ...
    get(multihash: MultiHash, options: Partial<GetObjectOptions>, callback: NodeCallback<DAGNode>): void;
    ...
    links(multihash: MultiHash, options: Partial<LinksOptions>, callback: NodeCallback<DAGLink[]>): void;
    ...
    stat(multihash: MultiHash, options: Partial<StatOptions>, callback: NodeCallback<StatResult>): void;

    patch: {
        addLink(multihash: MultiHash, link: DAGLink, options?: Partial<PathObjectOptions>): Promise<CID>;
        ...
        rmLink(multihash: MultiHash, link: DAGLinkRm, options?: Partial<PathObjectOptions>): Promise<CID>;
        rmLink(multihash: MultiHash, link: DAGLinkRm, callback: NodeCallback<CID>): void;
        rmLink(multihash: MultiHash, link: DAGLinkRm, options: PathObjectOptions, callback: NodeCallback<CID>): void;

        appendData(multihash: MultiHash, data: Buffer, options?: Partial<PathObjectOptions>): Promise<CID>;
        ...
        setData(multihash: MultiHash, data: Buffer, options: Partial<PathObjectOptions>, callback: Promise<CID>): void;
    };
}
